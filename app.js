...
let sprite1; //variable para el label
let canvas1, context1, texture1; // variables para creacion del label
...
0
    ...
    mesh1.position.y = .25;
    mesh1.name = 'KANJI'; //mensaje a mostrar cuando indicamos el mesh con nuestro mouse
    ...
    if (intersects.length > 0) {
        if (intersects[0].object != INTERSECTED) {
            ...
            if (INTERSECTED.name) {
                ...
                let message = 'Hola, mi nombre es: ' + INTERSECTED.name;
